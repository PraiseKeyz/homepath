      ...
      {landlord && (
        <>
          <div className="mt-5 grid grid-cols-3 gap-2">
            {[
              {
                val: landlord.totalListings,
                label: "Listings",
                color: "text-gray-900",
              },
              {
                val: landlord.propertiesSoldOrRented,
                label: "Closed Deals",
                color: "text-gray-900",
              },
              {
                val: landlord.availableListings,
                label: "Available",
              ...
              <div
                key={label}
                className="rounded-xl bg-gray-50 py-3 text-center"
              >
              ...
              <div className="border-b border-gray-100 pb-8">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  {[
                    ...
                    <span
                      key={label}
                      className="flex items-center gap-2 rounded-full bg-gray-100 px-4 py-2 text-sm font-semibold text-gray-700"
                    >
